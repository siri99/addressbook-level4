...
public class AddCommandSystemTest extends AddressBookSystemTest {
    ...
    //                .withAddress(VALID_ADDRESS_AMY).withTags(VALID_TAG_FRIEND).build();
    //        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_BOB + BIRTHDAY_DESC_BOB + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
    //                + TAG_DESC_FRIEND;
    //        assertCommandSuccess(command, toAdd);
    //
    ...
    //                .withAddress(VALID_ADDRESS_AMY).withTags(VALID_TAG_FRIEND).build();
    //        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + BIRTHDAY_DESC_BOB  + EMAIL_DESC_BOB + ADDRESS_DESC_AMY
    //                + TAG_DESC_FRIEND;
    //        assertCommandSuccess(command, toAdd);
    //
    ...
    //        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + BIRTHDAY_DESC_BOB + EMAIL_DESC_AMY + ADDRESS_DESC_BOB
    //                + TAG_DESC_FRIEND;
    //        assertCommandSuccess(command, toAdd);
    //
