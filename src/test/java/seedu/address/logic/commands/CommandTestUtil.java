...
public class CommandTestUtil {
    ...
    public static final String INVALID_BIRTHDAY_DESC = " " + PREFIX_BIRTHDAY + "5/March/1997"; // words not allowed for birthday
    ...
    static {
        ...
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                ...
                .withAddress(VALID_ADDRESS_BOB).withScore(VALID_SCORE_BOB).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).build();
    }
