...
|`* *` |experienced user| change the theme | I can change the theme of the program based on my taste

|`* *` |experienced user| upload avatar image | I can set up my profile image that I'd like to show to others
