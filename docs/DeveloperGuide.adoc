...
The Favourite List is a useful feature that allows a user to view all his/her favourite contacts in one place. It saves the time required to search for all the most important/favourite contacts.
...
_Figure 3.2.2 : Sequence Diagram of the interaction between ModelManager and AddressBook_
