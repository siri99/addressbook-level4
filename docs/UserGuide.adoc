...
Sorts the list persons in the address book in alphabhetical order of names. +
Format: `sort` or `so`
...
=== Listing all Favourite persons : `favlist` or `fl`
...
=== Removing a person from Favourite List : `fav` or `fv`
...
* `unfav 3` +
Adds the 3rd person listed in the Favourite list from the Favourite List.
