...
****
* Sorts the person by name (default).
* Also sorts the person by name when the command given is 'sort name'.
****

Examples:

* `sort` or `sort name` +
Sorts the persons in the address book by alphabhetical name order.

=== Displaying Favourite List : `flist` or `fl`
...
****
* Adds the person at the specified `INDEX` to the Favourite List.
* The index refers to the index number shown in the most recent listing.
* The index *must be a positive integer* `1, 2, 3, ...`
****
...
* `fav 1` +
`fv 2` +
Adds the 1st the 2nd person in the address book to the Favourite List.

=== Removing a person from Favourite List: `unfav` or `ufv`
...
****
* Removes the person at the specified `INDEX` from the Favourite List.
* The index refers to the index number shown in the most recent listing.
* The index *must be a positive integer* `1, 2, 3, ...`
****
...
* `unfav 1` +
`ufv 3` +
Removes the 1st the 3rd person in the address book from the Favourite List.
