...
It is mainly targeted towards university students. The user interacts with it using a CLI, and it has a GUI created with JavaFX.
It is written in Java, and has about 6 kLoC.

*Code contributed*: +
[https://github.com/CS2103AUG2017-T13-B2/main/blob/master/collated/main/siri99.md] +
 [https://github.com/CS2103AUG2017-T13-B2/main/blob/master/collated/test/siri99.md]
